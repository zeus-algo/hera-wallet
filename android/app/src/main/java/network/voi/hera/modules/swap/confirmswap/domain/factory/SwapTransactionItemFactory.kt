...
package network.voi.hera.modules.swap.confirmswap.domain.factory

import network.voi.hera.modules.swap.confirmswap.domain.mapper.SwapOptInTransactionMapper
import network.voi.hera.modules.swap.confirmswap.domain.mapper.SwapPeraFeeTransactionMapper
import network.voi.hera.modules.swap.confirmswap.domain.mapper.SwapSwapTransactionMapper
...
import network.voi.hera.modules.swap.confirmswap.domain.model.SwapTransactionPurpose
import network.voi.hera.modules.swap.confirmswap.domain.model.SwapTransactionPurpose.OPT_IN
import network.voi.hera.modules.swap.confirmswap.domain.model.SwapTransactionPurpose.PERA_FEE
import network.voi.hera.modules.swap.confirmswap.domain.model.SwapTransactionPurpose.SWAP
import network.voi.hera.modules.swap.confirmswap.domain.model.SwapTransactionPurpose.UNKNOWN
