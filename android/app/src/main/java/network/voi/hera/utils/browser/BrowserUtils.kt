...
package network.voi.hera.utils.browser
...
import network.voi.hera.utils.extensions.appendAt
...
private const val MARKET_PAGE_URL = "https://play.google.com/store/apps/details?id=network.voi.hera"
