...
package network.voi.hera.assetsearch.data.di

import network.voi.hera.assetsearch.data.mapper.AssetSearchDTOMapper
import network.voi.hera.assetsearch.data.repository.AssetSearchRepositoryImpl
import network.voi.hera.assetsearch.domain.repository.AssetSearchRepository
import network.voi.hera.assetsearch.domain.repository.AssetSearchRepository.Companion.REPOSITORY_INJECTION_NAME
