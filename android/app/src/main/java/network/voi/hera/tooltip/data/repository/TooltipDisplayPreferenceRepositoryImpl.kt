...
package network.voi.hera.tooltip.data.repository

import network.voi.hera.tooltip.data.local.TransactionDetailCopyAddressTooltipLocalSource
import network.voi.hera.tooltip.data.local.TransactionDetailCopyAddressTooltipLocalSource.Companion.defaultTransactionDetailTooltipPreference
import network.voi.hera.tooltip.domain.repository.TooltipDisplayPreferenceRepository
