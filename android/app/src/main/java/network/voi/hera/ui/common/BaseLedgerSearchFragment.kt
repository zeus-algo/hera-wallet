...
package network.voi.hera.ui.common
...
import network.voi.hera.customviews.LoadingDialogFragment
import network.voi.hera.databinding.FragmentLedgerSearchBinding
import network.voi.hera.ledger.LedgerBleOperationManager
import network.voi.hera.ledger.operations.AccountFetchAllOperation
...
import network.voi.hera.ui.ledgersearch.LedgerBaseItem
import network.voi.hera.ui.ledgersearch.LedgerPairInstructionsBottomSheet.Companion.BLUETOOTH_DEVICE_KEY
import network.voi.hera.ui.ledgersearch.LedgerSearchAdapter
import network.voi.hera.ui.ledgersearch.LedgerSearchViewModel
import network.voi.hera.utils.Event
import network.voi.hera.utils.areBluetoothPermissionsGranted
import network.voi.hera.utils.isLocationEnabled
