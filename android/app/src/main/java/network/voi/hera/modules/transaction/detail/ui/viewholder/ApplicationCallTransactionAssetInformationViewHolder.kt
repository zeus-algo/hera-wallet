...
import network.voi.hera.databinding.ItemTransactionApplicationCallAssetInformationBinding
import network.voi.hera.models.BaseViewHolder
import network.voi.hera.modules.transaction.detail.domain.usecase.ApplicationCallTransactionDetailPreviewUseCase.Companion.MAX_ASSET_COUNT_TO_SHOW
