...
import network.voi.hera.core.BaseActivity
...
import network.voi.hera.discover.common.ui.BaseDiscoverFragment
...
import network.voi.hera.discover.home.domain.PeraMobileWebInterface
import network.voi.hera.discover.home.domain.PeraMobileWebInterface.Companion.WEB_INTERFACE_NAME
import network.voi.hera.discover.home.domain.model.TokenDetailInfo
import network.voi.hera.discover.home.ui.adapter.DiscoverAssetSearchAdapter
...
import network.voi.hera.discover.utils.getDiscoverAuthHeader
import network.voi.hera.discover.utils.getDiscoverHomeUrl
