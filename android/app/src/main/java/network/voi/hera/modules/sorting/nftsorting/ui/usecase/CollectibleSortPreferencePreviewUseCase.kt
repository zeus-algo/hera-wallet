...
package network.voi.hera.modules.sorting.nftsorting.ui.usecase

import network.voi.hera.modules.sorting.nftsorting.domain.model.CollectibleSortPreference
import network.voi.hera.modules.sorting.nftsorting.domain.model.CollectibleSortPreference.ALPHABETICALLY_ASCENDING
import network.voi.hera.modules.sorting.nftsorting.domain.model.CollectibleSortPreference.ALPHABETICALLY_DESCENDING
import network.voi.hera.modules.sorting.nftsorting.domain.model.CollectibleSortPreference.NEWEST_TO_OLDEST
import network.voi.hera.modules.sorting.nftsorting.domain.model.CollectibleSortPreference.OLDEST_TO_NEWEST
import network.voi.hera.modules.sorting.nftsorting.domain.usecase.CollectibleSortTypeUseCase
import network.voi.hera.modules.sorting.nftsorting.ui.mapper.CollectibleSortPreferencePreviewMapper
import network.voi.hera.modules.sorting.nftsorting.ui.model.CollectibleSortPreferencePreview
