...
package network.voi.hera.modules.sorting.assetsorting.ui.usecase

import network.voi.hera.modules.sorting.assetsorting.domain.model.AssetSortPreference
import network.voi.hera.modules.sorting.assetsorting.domain.model.AssetSortPreference.ALPHABETICALLY_ASCENDING
import network.voi.hera.modules.sorting.assetsorting.domain.model.AssetSortPreference.ALPHABETICALLY_DESCENDING
import network.voi.hera.modules.sorting.assetsorting.domain.model.AssetSortPreference.BALANCE_ASCENDING
import network.voi.hera.modules.sorting.assetsorting.domain.model.AssetSortPreference.BALANCE_DESCENDING
import network.voi.hera.modules.sorting.assetsorting.domain.usecase.AssetSortTypeUseCase
import network.voi.hera.modules.sorting.assetsorting.ui.mapper.AssetSortPreferencePreviewMapper
