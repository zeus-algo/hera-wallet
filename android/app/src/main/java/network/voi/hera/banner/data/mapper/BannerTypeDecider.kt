...
package network.voi.hera.banner.data.mapper

import network.voi.hera.banner.data.model.BannerTypeResponse
import network.voi.hera.banner.domain.model.BannerType
