...
package network.voi.hera.modules.collectibles.detail.base.ui
...
import network.voi.hera.customviews.CollectibleMediaPager
...
import network.voi.hera.modules.collectibles.action.optin.CollectibleOptInActionBottomSheet.Companion.OPT_IN_COLLECTIBLE_ACTION_RESULT_KEY
import network.voi.hera.modules.collectibles.action.optout.CollectibleOptOutConfirmationBottomSheet.Companion.COLLECTIBLE_OPT_OUT_KEY
...
import network.voi.hera.ui.send.confirmation.ui.TransactionConfirmationFragment.Companion.TRANSACTION_CONFIRMATION_KEY
import network.voi.hera.utils.AccountDisplayName
import network.voi.hera.utils.AssetName
import network.voi.hera.utils.PrismUrlBuilder
import network.voi.hera.utils.browser.openAccountAddressInAlgoExplorer
