...
package network.voi.hera.nft.domain.mapper

import network.voi.hera.modules.collectibles.detail.base.data.model.CollectibleDetailDTO
import network.voi.hera.nft.domain.model.BaseCollectibleDetail.AudioCollectibleDetail
import network.voi.hera.nft.domain.model.BaseCollectibleDetail.ImageCollectibleDetail
import network.voi.hera.nft.domain.model.BaseCollectibleDetail.MixedCollectibleDetail
import network.voi.hera.nft.domain.model.BaseCollectibleDetail.NotSupportedCollectibleDetail
import network.voi.hera.nft.domain.model.BaseCollectibleDetail.VideoCollectibleDetail
